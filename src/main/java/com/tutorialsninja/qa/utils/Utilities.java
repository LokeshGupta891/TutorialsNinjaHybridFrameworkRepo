...
public class Utilities {
	...
	public static String generateEmailwithTimestamp()
	{
		...
		return "lokeshgupta"+timestamp+"@gmail.com";
	}
	
	public static Object[][] getTestDataFromExcel(String sheetName)
	{
		File excelFile = new File(System.getProperty("user.dir")+"//src//main//java//com//tutorials//qa//testdata//TutorialsNinjaTestDataFile.xlsx");
